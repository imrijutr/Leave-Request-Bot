...
- In a terminal, navigate to `LeaveRequestBot`

    ```bash
    # change into project folder
    cd LeaveRequestBot/CoreBot
    ```
...
- Run the bot from a terminal or from Visual Studio, choose option A or B.
  ...
  - Navigate to `LeaveRequestBot/CoreBot` folder
...
Generated with `dotnet new corebot` v4.14.1.2
